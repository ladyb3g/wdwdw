...
Users.MouseButton1Click:Connect(function()
    ...
    notify('Showing masked users names', '', 3)
end)
...
HighTool.MouseButton1Click:Connect(function()
    if player.Character:FindFirstChildWhichIsA('Tool') then
        ...
        notify('HighTool Error', 'you have to be holding a tool', 5)
    end
end)
...
LastingBullets.MouseButton1Click:Connect(function()
    if player.Character:FindFirstChildWhichIsA('Tool') then
        if player.Character:FindFirstChildWhichIsA('Tool'):FindFirstChild('Handle'):FindFirstChildWhichIsA('BillboardGui') then
            ...
            notify('LastingBullets Error', 'you have to be holding a gun', 5)
        end
    else
        notify('LastingBullets Error', 'you have to be holding a gun', 5)
    end
...
Aimlock.MouseButton1Click:Connect(function()
    if Aimlock.Text == 'Aimlock' then
        ...
        notify('Aimlock Enabled', 'you lock while holding rmb', 5)
    else
        Aimlock.Text = 'Aimlock'
    end
end)
...
Autofarm.MouseButton1Click:Connect(function()
    if AutoFarmWarning == false then
        ...
        notify('Autofarm Warning', 'press again to begin autofarming, this CANNOT be stopped', 10)
    else
        notify('Starting Autofarm', ':D', 5)
...
GrenadeLock.MouseButton1Click:Connect(function()
    ...
    GrenadeTool.Activated:Connect(function()
        ...
        if LowerTorso then
            ...
            TazerTarget = nil
            notify('Grenades unlocked', '', 3)
        end
    end)
end)

InfTools.MouseButton1Click:Connect(function()
    notify('Infinite Ammo Given', 'hold the tool to buy ammo shoot without reloading', 8)
    function infrev()
